...
<body>
    ...
    <div class="mainContainer">
        ...
        <main>
            ...
            <div class="userMain">
                <div class="userImg">
				    <img src="/upload/profile/${member.MEMBER_IMG != null ? member.MEMBER_IMG : 'default.png'}" alt="유저의 프로필 사진" id="profileDisplay">
				    ...
				    <form action="${pageContext.request.contextPath}/mvc/auth/undecided/updateOk.my" method="post" enctype="multipart/form-data" id="imageForm">
				        ...
				        <input type="file" name="profileFile" id="profileFileInput" style="display: none;" accept="image/*" onchange="submitImage()">
